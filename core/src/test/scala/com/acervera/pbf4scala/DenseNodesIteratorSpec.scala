...
class DenseNodesIteratorSpec extends WordSpec with Matchers {
  ...
  "The DenseNodesIterator should" should {
    "Read 6432 nodes" in {
      val strTable = StringTable parseFrom new FileInputStream("core/src/test/resources/com/acervera/pbf4scala/osmblock/denses/7875/strTable")
      val osmosisDense = DenseNodes parseFrom new FileInputStream("core/src/test/resources/com/acervera/pbf4scala/osmblock/denses/7875/0.dense")
      var counter = 0
    ...
    "Decode location" in {
      val strTable = StringTable parseFrom new FileInputStream("core/src/test/resources/com/acervera/pbf4scala/osmblock/denses/7875/strTable")
      val osmosisDense = DenseNodes parseFrom new FileInputStream("core/src/test/resources/com/acervera/pbf4scala/osmblock/denses/7875/0.dense")
      val expectedCoordIter = Source fromFile new File("core/src/test/resources/com/acervera/pbf4scala/osmblock/denses/7875/nodes_coord_list.txt") getLines()
