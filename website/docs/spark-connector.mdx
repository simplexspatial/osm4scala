...
This is the Spark/Scala version combination available for latest release v1.0.8:

| Spark Branch |  Scala | Packages |
|:------------:|:------:|:---------|
| 2.4          | 2.11   | [`com.acervera.osm4scala:osm4scala-spark2-shaded_2.11:1.0.8`](https://search.maven.org/artifact/com.acervera.osm4scala/osm4scala-spark2-shaded_2.11/1.0.8/jar)
| 2.4          | 2.12   | [`com.acervera.osm4scala:osm4scala-spark2-shaded_2.12:1.0.8`](https://search.maven.org/artifact/com.acervera.osm4scala/osm4scala-spark2-shaded_2.12/1.0.8/jar)
| 3.0 / 3.1    | 2.12   | [`com.acervera.osm4scala:osm4scala-spark3-shaded_2.12:1.0.8`](https://search.maven.org/artifact/com.acervera.osm4scala/osm4scala-spark3-shaded_2.12/1.0.8/jar)
...
1. Start the spark shell as usual, using the `--packages` option to add the right dependency. The dependency will depend to
   the Spark Version that you are using. Please, check the reference table in the previous section.
    ```shell title="Scala"
    bin/spark-shell --packages 'com.acervera.osm4scala:osm4scala-spark3-shaded_2.12:1.0.8'
    ```
    ```scala title="PySpark"
    bin/pyspark --packages 'com.acervera.osm4scala:osm4scala-spark3-shaded_2.12:1.0.8'
    ```
    ```scala title="SQL"
    bin/spark-sql --packages 'com.acervera.osm4scala:osm4scala-spark3-shaded_2.12:1.0.8'
    ```
...
2. Add a new Cell and import the right osm4scala library for your Notebook installation, following the table at the start
   ...
   ```jypiter
   %%init_spark
   launcher.packages = ["com.acervera.osm4scala:osm4scala-spark3-shaded_2.12:1.0.8"]
   ```
...
1. Import the spark connector **it is not really necessary** because the integration is transparent.
    ...
    **For Python**, like in Scala, it is not necessary to import the library except in runtime. But unlike in Scala, you
    ...
    ```sbt title="Sbt"
    libraryDependencies += "com.acervera.osm4scala" % "osm4scala-spark3-shaded_2.12" % "1.0.8"
    ```
    ```xml title="Maven"
    <dependency>
...
3. Submit the application to your Spark cluster.
    ```shell title="Scala"
    bin/spark-submit \
        --packages 'com.acervera.osm4scala:osm4scala-spark3-shaded_2.12:1.0.8' \
    ...
    You will not need to add `--packages 'com.acervera.osm4scala:osm4scala-spark3-shaded_2.12:1.0.8'` if it is part of the
    deployed artifact.
...
|:------------:|:-------:|:------:|:---------|
| 2.4          | 0.9.7  | 2.11   | [`com.acervera.osm4scala:osm4scala-spark2_2.11:1.0.8`](https://search.maven.org/artifact/com.acervera.osm4scala/osm4scala-spark2_2.11/1.0.8/jar)
| 2.4          | 0.10.2 | 2.12   | [`com.acervera.osm4scala:osm4scala-spark2_2.12:1.0.8`](https://search.maven.org/artifact/com.acervera.osm4scala/osm4scala-spark2_2.12/1.0.8/jar)
| 3.0 / 3.1    | 0.10.2 | 2.12   | [`com.acervera.osm4scala:osm4scala-spark3_2.12:1.0.8`](https://search.maven.org/artifact/com.acervera.osm4scala/osm4scala-spark3_2.12/1.0.8/jar)
